...
_SENTENCE_OPTION_PATTERNS: list = [
    ...
    ("叫什么名字",   [
        ...
        {"zh": "我有个中文名，叫___。",  "py": "Wǒ yǒu gè Zhōngwén míng, jiào ___.", "en": "I have a Chinese name — it's ___."},
    ]),
    ("怎么叫",       [
        {"zh": "大家叫我___。",          "py": "Dàjiā jiào wǒ ___.",              "en": "People call me ___."},
        {"zh": "叫我___就好了。",        "py": "Jiào wǒ ___ jiù hǎo le.",         "en": "Just call me ___."},
        {"zh": "没有外号，叫全名就好。", "py": "Méiyǒu wàihào, jiào quán míng jiù hǎo.", "en": "No nickname — full name is fine."},
    ]),
    ("名字是什么意思", [
        {"zh": "有一点复杂。",     "py": "Yǒu yīdiǎn fùzá.",     "en": "It's a bit complicated."},
        {"zh": "有正面的意思，代表美好的东西。", "py": "Yǒu zhèngmiàn de yìsi, dàibiǎo měihǎo de dōngxi.", "en": "A positive meaning — represents something good."},
        {"zh": "我不太清楚。",     "py": "Wǒ bù tài qīngchǔ.",   "en": "I'm not quite sure."},
    ]),
    ("觉得你的名字怎么样", [
        {"zh": "我觉得还不错。",   "py": "Wǒ juéde hái búcuò.",   "en": "I think it's pretty good."},
        {"zh": "还好，就是太普通了。", "py": "Hái hǎo, jiùshì tài pǔtōng le.", "en": "It's fine — just a bit too common."},
    ...
    ("谁给你取",     [
        ...
        {"zh": "是我自己选的，家人同意了。", "py": "Shì wǒ zìjǐ xuǎn de, jiārén tóngyì le.", "en": "I chose it myself — family agreed."},
    ]),
    ("有什么故事",   [
        {"zh": "有，是家人的一个决定。", "py": "Yǒu, shì jiārén de yīgè juédìng.", "en": "Yes — it was a family decision."},
    ...
    # — Food —
    ("最喜欢什么食物", [
        {"zh": "我最喜欢吃火锅。",               "py": "Wǒ zuì xǐhuān chī huǒguō.",                "en": "I love hot pot most."},
        {"zh": "我很喜欢面食，特别是饺子。",     "py": "Wǒ hěn xǐhuān miànshí, tèbié shì jiǎozi.", "en": "I love noodles and dumplings especially."},
        {"zh": "我喜欢家里的菜，妈妈做的最好。", "py": "Wǒ xǐhuān jiālǐ de cài, māma zuò de zuì hǎo.", "en": "I like home cooking — mum's is the best."},
    ]),
    ("好吃吗",       [
        {"zh": "很好吃！我很推荐。",     "py": "Hěn hǎochī! Wǒ hěn tuījiàn.",       "en": "Very delicious! I highly recommend it."},
        {"zh": "还可以，值得试试。",     "py": "Hái kěyǐ, zhídé shì shi.",           "en": "It's alright — worth trying."},
        {"zh": "有一点特别，可能要习惯。","py": "Yǒu yīdiǎn tèbié, kěnéng yào xíguàn.", "en": "A bit unusual — might take getting used to."},
    ]),
    ("好吃的",       [
        {"zh": "有很多特色的小吃。",   "py": "Yǒu hěn duō tèsè de xiǎochī.",   "en": "Lots of local specialties."},
        {"zh": "有很多好吃的！",       "py": "Yǒu hěn duō hǎochī de!",         "en": "There's lots of good food!"},
        {"zh": "很难说，每样都好吃！", "py": "Hěn nán shuō, měi yàng dōu hǎochī!", "en": "Hard to say — everything is delicious!"},
    ]),
    ("最有名的菜",   [
        {"zh": "___最有名。",      "py": "___ zuì yǒumíng.",       "en": "___ is most famous."},
        {"zh": "很多人喜欢吃火锅。",       "py": "Hěn duō rén xǐhuān chī huǒguō.", "en": "Many people love hot pot."},
        {"zh": "饺子、面条这些都很有名。", "py": "Jiǎozi, miàntiáo zhèxiē dōu hěn yǒumíng.", "en": "Dumplings and noodles — very well known."},
    ]),
    ("吃东西是一种享受", [
    ...
    ("贵不贵",       [
        {"zh": "不贵，很划算。",       "py": "Bù guì, hěn huásuàn.",           "en": "Not expensive — great value."},
        {"zh": "有一点贵，但值得。",   "py": "Yǒu yīdiǎn guì, dàn zhídé.",     "en": "A bit pricey, but worth it."},
        {"zh": "看地方，有贵有便宜。", "py": "Kàn dìfāng, yǒu guì yǒu piányí.", "en": "Depends on the place — varies."},
    ]),
    ("喜欢吃什么",   [
    ...
    ("想去哪",       [
        {"zh": "我想去欧洲，历史很丰富。",       "py": "Wǒ xiǎng qù Ōuzhōu, lìshǐ hěn fēngfù.",        "en": "I want to go to Europe — very rich history."},
        {"zh": "我想去日本，喜欢那里的文化。",   "py": "Wǒ xiǎng qù Rìběn, xǐhuān nàlǐ de wénhuà.",    "en": "I want to go to Japan — I love the culture."},
        {"zh": "我想去没去过的地方，越远越好。", "py": "Wǒ xiǎng qù méi qùguò de dìfāng, yuè yuǎn yuè hǎo.", "en": "Somewhere I've never been — the farther the better."},
    ]),
    ("最喜欢哪里",   [
        {"zh": "日本印象最深。",               "py": "Rìběn yìnxiàng zuì shēn.",               "en": "Japan left the deepest impression."},
        {"zh": "欧洲，那里的文化很有意思。",   "py": "Ōuzhōu, nàlǐ de wénhuà hěn yǒuyìsi.",   "en": "Europe — the culture is very interesting."},
        {"zh": "很难说，每个地方都不一样。",   "py": "Hěn nán shuō, měi gè dìfāng dōu bù yīyàng.", "en": "Hard to say — every place is different."},
    ]),
    ("自己去还是",    [
        {"zh": "一般跟朋友一起去。",         "py": "Yībān gēn péngyǒu yīqǐ qù.",         "en": "Usually with friends."},
        {"zh": "两种都有，看去哪里。",       "py": "Liǎng zhǒng dōu yǒu, kàn qù nǎlǐ.", "en": "Both — depends on where."},
        {"zh": "我喜欢自己去，比较自由。",   "py": "Wǒ xǐhuān zìjǐ qù, bǐjiào zìyóu.", "en": "I prefer going alone — more freedom."},
    ]),
    ("旅行的时候",   [
        {"zh": "我最喜欢吃当地的食物。",       "py": "Wǒ zuì xǐhuān chī dāngdì de shíwù.",     "en": "I love eating local food most."},
        {"zh": "我喜欢走路，发现新地方。",     "py": "Wǒ xǐhuān zǒulù, fāxiàn xīn dìfāng.",   "en": "I like walking and discovering new places."},
        {"zh": "我喜欢和当地人聊天，了解文化。","py": "Wǒ xǐhuān hé dāngdì rén liáotiān, liǎojiě wénhuà.", "en": "I like chatting with locals — learning about the culture."},
    ]),
    ("好玩的",       [
        {"zh": "有很多特色的小店和街道。",     "py": "Yǒu hěn duō tèsè de xiǎodiàn hé jiēdào.", "en": "Lots of unique shops and streets."},
        {"zh": "当地的食物很好吃，值得试试。", "py": "Dāngdì de shíwù hěn hǎochī, zhídé shì shi.", "en": "The local food is great — worth trying."},
        {"zh": "风景很美，特别适合走路探索。", "py": "Fēngjǐng hěn měi, tèbié shìhé zǒulù tànsuǒ.", "en": "Beautiful scenery — great for exploring on foot."},
    ]),
    # — Family —
    ("跟家人住在一起", [
    ...
    ("和家人一起做",  [
        {"zh": "一起吃饭，聊聊天。",               "py": "Yīqǐ chīfàn, liáo liáo tiān.",                       "en": "Have meals together and chat."},
        {"zh": "一起看电影。",                     "py": "Yīqǐ kàn diànyǐng.",                                 "en": "Watch movies together."},
        {"zh": "一起旅行，这对我们来说很重要。",   "py": "Yīqǐ lǚxíng, zhè duì wǒmen lái shuō hěn zhòngyào.", "en": "Travel together — that's very important to us."},
    ]),
    # — Work / Study —
    ("喜欢你的工作",  [
        {"zh": "很喜欢！很有意思。",       "py": "Hěn xǐhuān! Hěn yǒuyìsi.",         "en": "I love it! It's interesting."},
        {"zh": "还可以，有好有坏。",       "py": "Hái kěyǐ, yǒu hǎo yǒu huài.",     "en": "It's alright, has its ups and downs."},
        {"zh": "不太喜欢，但是没办法。",   "py": "Bù tài xǐhuān, dànshì méi bànfǎ.", "en": "Not really, but what can you do."},
    ]),
    ("为什么喜欢这份工作", [
        {"zh": "因为可以帮助别人。",           "py": "Yīnwèi kěyǐ bāngzhù biérén.",           "en": "Because I get to help people."},
        {"zh": "因为有成就感。",               "py": "Yīnwèi yǒu chéngjiùgǎn.",               "en": "Because it's fulfilling."},
        {"zh": "其实我也不确定，但是习惯了。", "py": "Qíshí wǒ yě bù quèdìng, dànshì xíguàn le.", "en": "Honestly not sure, but I'm used to it now."},
    ]),
    ("工作难吗",      [
    ...
    ("做什么工作",    [
        ...
        {"zh": "我在公司做管理。",       "py": "Wǒ zài gōngsī zuò guǎnlǐ.",   "en": "I'm in management at a company."},
        {"zh": "我现在退休了。",             "py": "Wǒ xiànzài tuìxiū le.",         "en": "I'm retired now."},
    ]),
    ("工作的时候",    [
    ...
    ("什么爱好",      [
        ...
        {"zh": "我喜欢运动，特别是跑步。",         "py": "Wǒ xǐhuān yùndòng, tèbié shì pǎobù.",  "en": "I like sport, especially running."},
        {"zh": "我喜欢旅行，探索新的地方。",       "py": "Wǒ xǐhuān lǚxíng, tànsuǒ xīn dìfāng.", "en": "I like travelling and exploring new places."},
    ]),
    ("喜欢做什么",    [
        {"zh": "我喜欢看书。",                     "py": "Wǒ xǐhuān kàn shū.",                         "en": "I like reading."},
        {"zh": "我喜欢运动。",                     "py": "Wǒ xǐhuān yùndòng.",                         "en": "I like sport."},
        {"zh": "我喜欢和朋友出去，发现新地方。",   "py": "Wǒ xǐhuān hé péngyǒu chūqù, fāxiàn xīn dìfāng.", "en": "I like going out with friends and discovering new places."},
    ]),
    # — Work: additional specific patterns —
    ("工作忙",        [
        {"zh": "很忙！没有时间。",               "py": "Hěn máng! Méiyǒu shíjiān.",                     "en": "Very busy! No time at all."},
        {"zh": "还好，不是太忙。",               "py": "Hái hǎo, bú shì tài máng.",                     "en": "OK, not too busy."},
        {"zh": "最近有点忙，事情比较多。",         "py": "Zuìjìn yǒudiǎn máng, shìqing bǐjiào duō.",     "en": "Lately a bit busy — quite a lot going on."},
    ]),
    ("在哪个公司",    [
        {"zh": "我在一家外资公司。",             "py": "Wǒ zài yījiā wàizī gōngsī.",                    "en": "I work at a foreign company."},
        {"zh": "是家本地公司。",                 "py": "Shì jiā běndì gōngsī.",                         "en": "It's a local company."},
        {"zh": "我在大学工作。",                 "py": "Wǒ zài dàxué gōngzuò.",                         "en": "I work at a university."},
    ]),
    ("工作在哪儿",    [
        {"zh": "在市中心。",                     "py": "Zài shì zhōngxīn.",                             "en": "In the city centre."},
        {"zh": "在家工作，比较灵活。",           "py": "Zài jiā gōngzuò, bǐjiào línghuó.",              "en": "I work from home — pretty flexible."},
        {"zh": "在公司办公室，每天通勤。",       "py": "Zài gōngsī bàngōngshì, měitiān tōngqín.",       "en": "In an office — I commute every day."},
    ]),
    ("做这个工作多久", [
        {"zh": "已经做了五年了。",               "py": "Yǐjīng zuò le wǔ nián le.",                     "en": "I've been doing it for five years."},
        {"zh": "不太久，才一两年。",             "py": "Bù tài jiǔ, cái yī liǎng nián.",                "en": "Not long — only a year or two."},
        {"zh": "很久了，从毕业就开始了。",       "py": "Hěn jiǔ le, cóng bìyè jiù kāishǐ le.",         "en": "A long time — since I graduated."},
    ]),
    ("怎么开始做这个工作", [
        {"zh": "是朋友介绍的。",                 "py": "Shì péngyǒu jièshào de.",                       "en": "A friend introduced me."},
        {"zh": "是学这个专业的。",               "py": "Shì xué zhège zhuānyè de.",                     "en": "I studied this field."},
        {"zh": "其实是一个意外，说来话长。",     "py": "Qíshí shì yīgè yìwài, shuō lái huà cháng.",     "en": "Actually by accident — it's a long story."},
    ]),
    ("当时想做的工作", [
        {"zh": "是的，一直是我的梦想。",         "py": "Shì de, yīzhí shì wǒ de mèngxiǎng.",            "en": "Yes, it's always been my dream."},
        {"zh": "不是，当时没想这么多。",         "py": "Bú shì, dāngshí méi xiǎng zhème duō.",          "en": "No, I didn't think about it much back then."},
        {"zh": "有一点，不过没想太多。",           "py": "Yǒu yīdiǎn, bùguò méi xiǎng tài duō.",         "en": "Sort of — but I didn't think too much about it."},
    ]),
    ("以后还想做",    [
        {"zh": "是的，我很喜欢。",               "py": "Shì de, wǒ hěn xǐhuān.",                        "en": "Yes, I love it."},
        {"zh": "不确定，看情况。",               "py": "Bù quèdìng, kàn qíngkuàng.",                    "en": "Not sure, depends on how things go."},
        {"zh": "不，我想换一个方向。",           "py": "Bù, wǒ xiǎng huàn yīgè fāngxiàng.",             "en": "No, I want to try something different."},
    ]),
    ("最喜欢哪个部分", [
        {"zh": "我最喜欢解决问题。",             "py": "Wǒ zuì xǐhuān jiějué wèntí.",                   "en": "I like solving problems best."},
        {"zh": "和同事合作的时候。",             "py": "Hé tóngshì hézuò de shíhòu.",                   "en": "When collaborating with colleagues."},
        {"zh": "看到成果的时候，很有成就感。",   "py": "Kàn dào chéngguǒ de shíhòu, hěn yǒu chéngjiùgǎn.", "en": "Seeing results — very fulfilling."},
    ]),
    ("最难的部分",    [
        {"zh": "时间管理最难。",                 "py": "Shíjiān guǎnlǐ zuì nán.",                       "en": "Time management is the hardest."},
        {"zh": "有时候客户不好沟通。",           "py": "Yǒushíhou kèhù bù hǎo gōutōng.",                "en": "Sometimes clients are hard to deal with."},
        {"zh": "要平衡工作和生活，不容易。",     "py": "Yào pínghéng gōngzuò hé shēnghuó, bù róngyì.", "en": "Balancing work and life — not easy."},
    ]),
    ("推荐年轻人做",  [
        {"zh": "推荐，很有前途。",               "py": "Tuījiàn, hěn yǒu qiántú.",                      "en": "Yes — great prospects."},
        {"zh": "要看每个人的情况。",             "py": "Yào kàn měi gè rén de qíngkuàng.",              "en": "Depends on the person."},
        {"zh": "推荐，但要有热情才行。",         "py": "Tuījiàn, dàn yào yǒu rèqíng cái xíng.",         "en": "Yes, but you need real passion."},
    ]),
    ("以前做什么工作", [
        {"zh": "我以前是老师。",                 "py": "Wǒ yǐqián shì lǎoshī.",                         "en": "I was a teacher."},
        {"zh": "做了很多年工程师。",             "py": "Zuò le hěn duō nián gōngchéngshī.",             "en": "I was an engineer for many years."},
        {"zh": "在大学教书。",                   "py": "Zài dàxué jiāoshū.",                             "en": "I taught at a university."},
    ]),
    ("收入怎么样",    [
        {"zh": "还可以，不算太高。",             "py": "Hái kěyǐ, bù suàn tài gāo.",                    "en": "Alright — not too high."},
        {"zh": "比较稳定。",                     "py": "Bǐjiào wěndìng.",                               "en": "Pretty stable."},
        {"zh": "够用就好，不太在意。",           "py": "Gòu yòng jiù hǎo, bù tài zàiyì.",               "en": "Enough is fine — I don't focus on it."},
    ]),
    # — Place: additional specific patterns —
    ("老家在哪儿",    [
        {"zh": "在一个小城市。",                 "py": "Zài yīgè xiǎo chéngshì.",                       "en": "In a small city."},
        {"zh": "离这里不太远，大概两三个小时。", "py": "Lí zhèlǐ bù tài yuǎn, dàgài liǎng sān gè xiǎoshí.", "en": "Not too far — about two or three hours away."},
        {"zh": "在农村，很安静，和城市不一样。", "py": "Zài nóngcūn, hěn ānjìng, hé chéngshì bù yīyàng.", "en": "In the countryside — very quiet, quite different from the city."},
    ]),
    ("去别的地方",    [
        {"zh": "会，我很喜欢旅行。",             "py": "Huì, wǒ hěn xǐhuān lǚxíng.",                     "en": "Yes — I love travelling."},
        {"zh": "偶尔会，不太常去。",             "py": "Ǒu'ěr huì, bù tài cháng qù.",                   "en": "Occasionally — not that often."},
        {"zh": "想去，但工作太忙，没时间。",     "py": "Xiǎng qù, dàn gōngzuò tài máng, méi shíjiān.",  "en": "Would like to, but work is too busy — no time."},
    ]),
    ("跟谁一起住",    [
        {"zh": "我跟家人一起住。",               "py": "Wǒ gēn jiārén yīqǐ zhù.",                       "en": "I live with family."},
        {"zh": "我一个人住。",                   "py": "Wǒ yīgè rén zhù.",                              "en": "I live alone."},
        {"zh": "我跟妻子和父母住在一起。",       "py": "Wǒ gēn qīzi hé fùmǔ zhù zài yīqǐ.",             "en": "I live with my wife and parents."},
    ]),
    ("为什么住在这里", [
        {"zh": "因为工作在这里。",               "py": "Yīnwèi gōngzuò zài zhèlǐ.",                     "en": "Because work is here."},
        {"zh": "因为家人在这里。",               "py": "Yīnwèi jiārén zài zhèlǐ.",                      "en": "Because my family is here."},
        {"zh": "因为我喜欢这里的生活节奏。",     "py": "Yīnwèi wǒ xǐhuān zhèlǐ de shēnghuó jiézòu.",    "en": "Because I love the pace of life here."},
    ]),
    ("住了多久",      [
        {"zh": "住了十几年了。",                 "py": "Zhù le shí jǐ nián le.",                        "en": "Over ten years now."},
        {"zh": "才住了几年。",                   "py": "Cái zhù le jǐ nián.",                           "en": "Only a few years."},
        {"zh": "很久了，我在这里长大的。",       "py": "Hěn jiǔ le, wǒ zài zhèlǐ zhǎng dà de.",         "en": "A long time — I grew up here."},
    ]),
    ("想念老家",      [
        {"zh": "会的，有时候很想念。",           "py": "Huì de, yǒushíhou hěn xiǎngniàn.",              "en": "Yes, sometimes I miss it a lot."},
        {"zh": "不太想，现在这里也很好。",       "py": "Bù tài xiǎng, xiànzài zhèlǐ yě hěn hǎo.",       "en": "Not really — it's great here now."},
        {"zh": "会想念，特别是家人和食物。",     "py": "Huì xiǎngniàn, tèbié shì jiārén hé shíwù.",      "en": "Yes, especially family and the food."},
    ]),
    ("长期住",        [
        {"zh": "应该会，已经习惯了。",           "py": "Yīnggāi huì, yǐjīng xíguàn le.",                "en": "Probably — I'm used to it now."},
        {"zh": "不确定，也许会回老家。",         "py": "Bù quèdìng, yěxǔ huì huí lǎojiā.",              "en": "Not sure — might go back home."},
        {"zh": "是的，我很喜欢这里的生活。",     "py": "Shì de, wǒ hěn xǐhuān zhèlǐ de shēnghuó.",      "en": "Yes — I love life here."},
    ]),
    # — Family: additional specific patterns —
    ("你多大了",      [
        {"zh": "三十多岁了。",               "py": "Sānshí duō suì le.",                     "en": "In my thirties."},
        {"zh": "快四十了，时间过得真快。",   "py": "Kuài sìshí le, shíjiān guò de zhēn kuài.", "en": "Almost forty — time flies."},
        {"zh": "才二十出头，还年轻！",       "py": "Cái èrshí chū tóu, hái niánqīng!",       "en": "Only in my early twenties — still young!"},
    ]),
    ("多大了",        [
        {"zh": "三十多岁了。",                   "py": "Sānshí duō suì le.",                             "en": "In their thirties."},
        {"zh": "比我大几岁，我们年纪差不多。",   "py": "Bǐ wǒ dà jǐ suì, wǒmen niánjì chàbuduō.",       "en": "A few years older than me — close in age."},
        {"zh": "已经六十多了，年纪不小了。",     "py": "Yǐjīng liùshí duō le, niánjì bù xiǎo le.",      "en": "Already in their sixties — getting on in years."},
    ]),
    ("住在哪里",      [
        {"zh": "跟我住在一起。",                 "py": "Gēn wǒ zhù zài yīqǐ.",                          "en": "Lives with me."},
        {"zh": "住在另一个城市。",               "py": "Zhù zài lìng yīgè chéngshì.",                   "en": "Lives in another city."},
        {"zh": "住在老家，离我比较远。",         "py": "Zhù zài lǎojiā, lí wǒ bǐjiào yuǎn.",            "en": "Lives back home — quite far from me."},
    ]),
    ("家里谁最亲近",  [
        {"zh": "和我妈妈最亲近。",               "py": "Hé wǒ māma zuì qīnjìn.",                        "en": "Closest to my mum."},
        {"zh": "和老婆最亲近。",                 "py": "Hé lǎopó zuì qīnjìn.",                          "en": "Closest to my wife."},
        {"zh": "和我姐姐最亲近。",               "py": "Hé wǒ jiějiě zuì qīnjìn.",                      "en": "Closest to my older sister."},
    ]),
    ("对你最重要",    [
        {"zh": "当然是父母。",                   "py": "Dāngrán shì fùmǔ.",                             "en": "My parents, of course."},
        {"zh": "我觉得是我的孩子。",             "py": "Wǒ juéde shì wǒ de háizi.",                     "en": "I think it's my children."},
        {"zh": "是我老婆，她支持我做的一切。",   "py": "Shì wǒ lǎopó, tā zhīchí wǒ zuò de yīqiè.",      "en": "My wife — she supports everything I do."},
    ]),
    # — Hobby: additional specific patterns —
    ("收藏什么",      [
        {"zh": "我收藏邮票。",                   "py": "Wǒ shōucáng yóupiào.",                          "en": "I collect stamps."},
        {"zh": "主要收藏茶叶。",                 "py": "Zhǔyào shōucáng cháyè.",                        "en": "Mainly tea leaves."},
        {"zh": "我收藏老物件，喜欢有历史的东西。","py": "Wǒ shōucáng lǎo wùjiàn, xǐhuān yǒu lìshǐ de dōngxi.", "en": "I collect antiques — I like things with history."},
    ]),
    ("在哪儿做",      [
        {"zh": "一般在家做。",                   "py": "Yībān zài jiā zuò.",                             "en": "Usually at home."},
        {"zh": "有时候在外面，有时候在家。",     "py": "Yǒushíhou zài wàimiàn, yǒushíhou zài jiā.",     "en": "Sometimes outside, sometimes at home."},
        {"zh": "喜欢去公园，环境好一点。",       "py": "Xǐhuān qù gōngyuán, huánjìng hǎo yīdiǎn.",     "en": "I like going to the park — better environment."},
    ]),
    ("周末做什么",    [
        {"zh": "我周末一般在家休息。",           "py": "Wǒ zhōumò yībān zài jiā xiūxi.",                "en": "On weekends I usually rest at home."},
        {"zh": "周末我喜欢出去走走。",           "py": "Zhōumò wǒ xǐhuān chūqù zǒu zou.",              "en": "On weekends I like to go out for a walk."},
        {"zh": "周末很少有空，经常有事。",       "py": "Zhōumò hěn shǎo yǒu kòng, jīngcháng yǒu shì.", "en": "Rarely have free time on weekends — always something going on."},
    ]),
    ("什么时候开始",  [
        {"zh": "大概三四年前吧。",               "py": "Dàgài sān sì nián qián ba.",                    "en": "About three or four years ago."},
        {"zh": "从学生时代就开始了。",           "py": "Cóng xuésheng shídài jiù kāishǐ le.",           "en": "Started since my student days."},
        {"zh": "很久了，已经记不太清楚了。",     "py": "Hěn jiǔ le, yǐjīng jì bu tài qīngchǔ le.",     "en": "A long time ago — I can't remember exactly."},
    ]),
    ("做了多久",      [
        {"zh": "大概三四年了。",                 "py": "Dàgài sān sì nián le.",                         "en": "About three or four years."},
        {"zh": "差不多十年了。",                 "py": "Chàbuduō shí nián le.",                         "en": "About ten years."},
        {"zh": "从小就开始了，很难说多久。",     "py": "Cóng xiǎo jiù kāishǐ le, hěn nán shuō duō jiǔ.", "en": "Since childhood — hard to say how long."},
    ]),
    ("爱好是怎么开始", [
        {"zh": "从小就有这个爱好了。",           "py": "Cóng xiǎo jiù yǒu zhège àihào le.",             "en": "Had this hobby since childhood."},
        {"zh": "是朋友带我去试试的。",           "py": "Shì péngyǒu dài wǒ qù shì shi de.",             "en": "A friend brought me along to try it."},
        {"zh": "是偶然的机会，没想到这么喜欢。", "py": "Shì ǒurán de jīhuì, méi xiǎngdào zhème xǐhuān.", "en": "A chance opportunity — didn't expect to like it so much."},
    ]),
    ("怎么开始这个爱好", [
        {"zh": "从小就开始了。",                 "py": "Cóng xiǎo jiù kāishǐ le.",                      "en": "I started when I was young."},
        {"zh": "是一个朋友介绍的。",             "py": "Shì yīgè péngyǒu jièshào de.",                  "en": "A friend introduced me to it."},
        {"zh": "慢慢喜欢上的，说不清楚。",         "py": "Màn man xǐhuān shàng de, shuō bu qīngchǔ.",     "en": "Gradually came to like it — hard to say exactly why."},
    ]),
    ("最喜欢这个爱好", [
        {"zh": "让我放松。",                     "py": "Ràng wǒ fàngsōng.",                             "en": "It helps me relax."},
        {"zh": "可以认识新朋友。",               "py": "Kěyǐ rènshí xīn péngyǒu.",                     "en": "I can meet new people."},
        {"zh": "让我忘记工作的压力。",           "py": "Ràng wǒ wàngjì gōngzuò de yālì.",               "en": "It helps me forget work stress."},
    ]),
    ("爱好对你",      [
        {"zh": "当然！很重要。",                 "py": "Dāngrán! Hěn zhòngyào.",                        "en": "Of course! Very important."},
        {"zh": "有一点，让我开心。",             "py": "Yǒu yīdiǎn, ràng wǒ kāixīn.",                  "en": "Somewhat — it makes me happy."},
        {"zh": "非常重要，少了它不行。",           "py": "Fēicháng zhòngyào, shǎo le tā bù xíng.",        "en": "Very important — I can't do without it."},
    ]),
    ("自己做还是",    [
        {"zh": "一般自己做。",                   "py": "Yībān zìjǐ zuò.",                               "en": "Usually alone."},
        {"zh": "经常和朋友一起。",               "py": "Jīngcháng hé péngyǒu yīqǐ.",                   "en": "Often with friends."},
        {"zh": "两种都有，看心情。",             "py": "Liǎng zhǒng dōu yǒu, kàn xīnqíng.",             "en": "Both — depends on my mood."},
    ]),
    # — Identity: additional specific patterns —
    ("你呢",          [
        {"zh": "我也是这样。",               "py": "Wǒ yě shì zhèyàng.",                "en": "Same here."},
        {"zh": "我有点不一样。",             "py": "Wǒ yǒudiǎn bù yīyàng.",             "en": "I'm a bit different."},
        {"zh": "我跟你说说。",               "py": "Wǒ gēn nǐ shuō shuō.",              "en": "Let me tell you about me."},
    ]),
    ("名字有故事",    [
        {"zh": "有！挺有意思的。",               "py": "Yǒu! Tǐng yǒuyìsi de.",                     "en": "Yes! Quite an interesting one."},
        {"zh": "有一点，但不太复杂。",           "py": "Yǒu yīdiǎn, dàn bù tài fùzá.",              "en": "A bit of one — not too complicated."},
        {"zh": "没有特别的，就是家人取的。",     "py": "Méiyǒu tèbié de, jiùshì jiārén qǔ de.",      "en": "Nothing special — family just chose it."},
    ]),
    ("喜欢自己的名字", [
        {"zh": "挺喜欢的，有意思。",             "py": "Tǐng xǐhuān de, yǒuyìsi.",                  "en": "Quite like it — it's interesting."},
        {"zh": "还可以，习惯了。",               "py": "Hái kěyǐ, xíguàn le.",                      "en": "It's OK — I'm used to it."},
        {"zh": "有时候觉得太普通了。",           "py": "Yǒushíhou juéde tài pǔtōng le.",             "en": "Sometimes feels a bit too ordinary."},
    ]),
    ("名字好听",      [
        {"zh": "我觉得还不错。",                 "py": "Wǒ juéde hái búcuò.",                        "en": "I think it's pretty nice."},
        {"zh": "还好，就是用惯了。",             "py": "Hái hǎo, jiùshì yòng guàn le.",              "en": "It's fine — I'm just used to it."},
        {"zh": "朋友说好听，我自己没感觉。",     "py": "Péngyǒu shuō hǎotīng, wǒ zìjǐ méi gǎnjué.", "en": "Friends say so — I don't really feel it myself."},
    ]),
    # — Food: additional specific patterns —
    ("喜欢吃辣",      [
        {"zh": "非常喜欢！越辣越好。",           "py": "Fēicháng xǐhuān! Yuè là yuè hǎo.",           "en": "Love it! The spicier the better."},
        {"zh": "还好，不太辣的可以。",           "py": "Hái hǎo, bù tài là de kěyǐ.",               "en": "It's OK — not too spicy is fine."},
        {"zh": "不太喜欢，吃辣会不舒服。",       "py": "Bù tài xǐhuān, chī là huì bù shūfu.",        "en": "Not really — spicy makes me feel unwell."},
    ]),
    ("什么味道",      [
        {"zh": "有点甜，又有点咸。",             "py": "Yǒudiǎn tián, yòu yǒudiǎn xián.",            "en": "A bit sweet and a bit salty."},
        {"zh": "味道很浓，很有特色。",           "py": "Wèidào hěn nóng, hěn yǒu tèsè.",             "en": "Strong flavour — very distinctive."},
        {"zh": "有点辣，但是很好吃。",           "py": "Yǒudiǎn là, dànshì hěn hǎochī.",             "en": "A little spicy, but very tasty."},
    ]),
    ("会自己做",      [
        {"zh": "会，常常自己做。",               "py": "Huì, chángcháng zìjǐ zuò.",                  "en": "Yes — I make it often."},
        {"zh": "会一点，但不太好。",             "py": "Huì yīdiǎn, dàn bù tài hǎo.",               "en": "A bit, but not very well."},
        {"zh": "不太会，比较难。",               "py": "Bù tài huì, bǐjiào nán.",                    "en": "Not really — it's quite hard."},
    ]),
    ("小时候常吃",    [
        {"zh": "是的，妈妈常做。",               "py": "Shì de, māma cháng zuò.",                    "en": "Yes — mum used to make it often."},
        {"zh": "有时候，节日的时候会吃。",       "py": "Yǒushíhou, jiérì de shíhou huì chī.",         "en": "Sometimes — especially at festivals."},
        {"zh": "不太多，那时候不常见。",         "py": "Bù tài duō, nà shíhou bù cháng jiàn.",        "en": "Not much — it wasn't common back then."},
    ]),
    ("愿意教我",      [
        {"zh": "当然！很简单的。",               "py": "Dāngrán! Hěn jiǎndān de.",                   "en": "Of course! It's quite simple."},
        {"zh": "可以，但需要一些材料。",         "py": "Kěyǐ, dàn xūyào yīxiē cáiliào.",             "en": "Sure, but you'll need some ingredients."},
        {"zh": "我自己也不太会，一起学吧！",     "py": "Wǒ zìjǐ yě bù tài huì, yīqǐ xué ba!",       "en": "I'm not great at it either — let's learn together!"},
    ]),
    # — Travel: additional specific patterns —
    ("去过吗",        [
        {"zh": "去过！很喜欢那里。",             "py": "Qùguò! Hěn xǐhuān nàlǐ.",                   "en": "Yes! I loved it there."},
        {"zh": "还没去过，但很想去。",           "py": "Hái méi qùguò, dàn hěn xiǎng qù.",           "en": "Not yet, but I'd love to."},
        {"zh": "去过一次，想再去。",             "py": "Qùguò yīcì, xiǎng zài qù.",                  "en": "Once — I'd like to go again."},
    ]),
    ("那次旅行怎么样", [
        {"zh": "非常好！印象很深。",             "py": "Fēicháng hǎo! Yìnxiàng hěn shēn.",           "en": "Excellent! Left a deep impression."},
        {"zh": "还不错，有些地方很特别。",       "py": "Hái búcuò, yǒuxiē dìfāng hěn tèbié.",         "en": "Pretty good — some parts were really special."},
        {"zh": "有点累，但值得。",               "py": "Yǒudiǎn lèi, dàn zhídé.",                    "en": "A bit tiring, but worth it."},
    ]),
    ("最难忘",        [
        {"zh": "去欧洲那次，见了很多新东西。",   "py": "Qù Ōuzhōu nà cì, jiàn le hěn duō xīn dōngxi.", "en": "The Europe trip — so many new things."},
        {"zh": "第一次出国的时候，印象很深。",   "py": "Dì yīcì chūguó de shíhou, yìnxiàng hěn shēn.", "en": "My first time abroad — left a deep impression."},
        {"zh": "最近去的那次，比较特别。",       "py": "Zuìjìn qù de nà cì, bǐjiào tèbié.",           "en": "The most recent one — pretty special."},
    ]),
    ("最喜欢哪次旅行", [
        {"zh": "去日本那次，喜欢那里的文化。",   "py": "Qù Rìběn nà cì, xǐhuān nàlǐ de wénhuà.",     "en": "The Japan trip — I loved the culture."},
        {"zh": "第一次长途旅行，很难忘。",       "py": "Dì yīcì cháng tú lǚxíng, hěn nán wàng.",     "en": "My first long trip — very memorable."},
        {"zh": "很难说，每次都有好的部分。",     "py": "Hěn nán shuō, měi cì dōu yǒu hǎo de bùfen.", "en": "Hard to say — every trip had its highlights."},
    ]),
    ("有什么特别",    [
        {"zh": "文化很有特色。",                 "py": "Wénhuà hěn yǒu tèsè.",                       "en": "The culture is very distinctive."},
        {"zh": "当地的食物很好吃，很有名。",     "py": "Dāngdì de shíwù hěn hǎochī, hěn yǒumíng.",   "en": "The local food is great and famous."},
        {"zh": "风景很美，和别的地方不一样。",   "py": "Fēngjǐng hěn měi, hé bié de dìfāng bù yīyàng.", "en": "Beautiful scenery — different from other places."},
    ]),
    ("跟谁一起去",    [
        {"zh": "跟朋友一起去的。",               "py": "Gēn péngyǒu yīqǐ qù de.",                    "en": "Went with friends."},
        {"zh": "和家人一起。",                   "py": "Hé jiārén yīqǐ.",                            "en": "With family."},
        {"zh": "一个人去，很自由。",             "py": "Yīgè rén qù, hěn zìyóu.",                    "en": "Went alone — very free."},
    ]),
    ("工作还是玩",    [
        {"zh": "是去玩的，难得的假期。",         "py": "Shì qù wán de, nán de de jiàqī.",             "en": "Going for fun — a rare holiday."},
        {"zh": "工作去的，但也有时间游览。",     "py": "Gōngzuò qù de, dàn yě yǒu shíjiān yóulǎn.",  "en": "For work, but had time to sightsee."},
        {"zh": "两个都有，工作和旅游结合。",     "py": "Liǎng gè dōu yǒu, gōngzuò hé lǚyóu jiéhé.", "en": "Both — combined work and travel."},
    ]),
    ("为什么喜欢那",  [
        {"zh": "因为那里的文化很有意思。",       "py": "Yīnwèi nàlǐ de wénhuà hěn yǒuyìsi.",         "en": "Because the culture there is fascinating."},
        {"zh": "因为食物很好吃，景色也很美。",   "py": "Yīnwèi shíwù hěn hǎochī, jǐngsè yě hěn měi.", "en": "Because the food is great and the scenery beautiful."},
        {"zh": "第一次去，什么都觉得新鲜。",     "py": "Dì yīcì qù, shénme dōu juéde xīnxiān.",      "en": "First time there — everything felt fresh."},
    ]),
    ("特别的意义",    [
        {"zh": "让我学到很多东西。",             "py": "Ràng wǒ xuédào hěn duō dōngxi.",              "en": "I learned a lot from it."},
        {"zh": "那次让我更了解自己。",           "py": "Nà cì ràng wǒ gèng liǎojiě zìjǐ.",           "en": "It helped me understand myself better."},
        {"zh": "说不清楚，就是很难忘。",         "py": "Shuō bu qīngchǔ, jiùshì hěn nán wàng.",      "en": "Hard to explain — just very memorable."},
    ]),
    # — Slot-followup: additional specific patterns —
    ("为什么好吃",    [
        {"zh": "因为材料很新鲜。",               "py": "Yīnwèi cáiliào hěn xīnxiān.",                "en": "Because the ingredients are fresh."},
        {"zh": "因为做法很特别。",               "py": "Yīnwèi zuòfǎ hěn tèbié.",                    "en": "Because the cooking method is unique."},
        {"zh": "很难说，就是好吃！",             "py": "Hěn nán shuō, jiùshì hǎochī!",               "en": "Hard to say — it's just delicious!"},
    ]),
    ("为什么有意思",  [
        {"zh": "因为那里的文化很不一样。",       "py": "Yīnwèi nàlǐ de wénhuà hěn bù yīyàng.",       "en": "Because the culture is so different."},
        {"zh": "有很多新鲜的东西可以发现。",     "py": "Yǒu hěn duō xīnxiān de dōngxi kěyǐ fāxiàn.", "en": "So many new things to discover."},
        {"zh": "说不清楚，去了就知道。",         "py": "Shuō bu qīngchǔ, qù le jiù zhīdào.",         "en": "Hard to explain — you'd have to go yourself."},
    ]),
    ("哪个地方最有意思", [
        {"zh": "日本，文化很特别。",             "py": "Rìběn, wénhuà hěn tèbié.",                   "en": "Japan — very distinctive culture."},
        {"zh": "欧洲，历史很丰富。",             "py": "Ōuzhōu, lìshǐ hěn fēngfù.",                  "en": "Europe — very rich history."},
        {"zh": "每个地方都有意思，很难选。",     "py": "Měi gè dìfāng dōu yǒuyìsi, hěn nán xuǎn.",   "en": "Every place is interesting — hard to choose."},
    ]),
    ("为什么喜欢那儿", [
        {"zh": "因为那里的生活很方便。",         "py": "Yīnwèi nàlǐ de shēnghuó hěn fāngbiàn.",      "en": "Because life there is very convenient."},
        {"zh": "因为那里的人很友好。",           "py": "Yīnwèi nàlǐ de rén hěn yǒuhǎo.",             "en": "Because the people there are very friendly."},
        {"zh": "因为有很多我喜欢的食物和地方。", "py": "Yīnwèi yǒu hěn duō wǒ xǐhuān de shíwù hé dìfāng.", "en": "Because of all the food and places I love."},
    ]),
    # — Life: additional specific patterns —
    ("有什么计划",    [
        {"zh": "还没想好。",                     "py": "Hái méi xiǎng hǎo.",                         "en": "Haven't decided yet."},
        {"zh": "想去旅行，放松一下。",           "py": "Xiǎng qù lǚxíng, fàngsōng yīxià.",           "en": "Want to travel — relax a bit."},
        {"zh": "有一些计划，但还不确定。",       "py": "Yǒu yīxiē jìhuà, dàn hái bù quèdìng.",       "en": "Have some plans, but not certain yet."},
    ]),
    ("什么时候见面",  [
        {"zh": "随时都可以！",                   "py": "Suíshí dōu kěyǐ!",                           "en": "Anytime!"},
        {"zh": "下周比较方便。",                 "py": "Xià zhōu bǐjiào fāngbiàn.",                  "en": "Next week works better."},
        {"zh": "我最近比较忙，稍后再约吧。",     "py": "Wǒ zuìjìn bǐjiào máng, shāo hòu zài yuē ba.", "en": "I've been quite busy — let's schedule later."},
    ]),
    ("觉得这个怎么样", [
        {"zh": "我觉得挺好的。",                 "py": "Wǒ juéde tǐng hǎo de.",                      "en": "I think it's pretty good."},
        {"zh": "有一点意思，但不确定。",         "py": "Yǒu yīdiǎn yìsi, dàn bù quèdìng.",           "en": "Somewhat interesting — not sure."},
        {"zh": "说不太清楚，还在想。",           "py": "Shuō bù tài qīngchǔ, hái zài xiǎng.",        "en": "Hard to say — still thinking about it."},
    ]),
