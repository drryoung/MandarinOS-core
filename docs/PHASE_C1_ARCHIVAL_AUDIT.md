...
| **C2C-core** | Candidate implemented — pending review and approval | Twenty low-risk class-C briefings relocated; no AI/bootstrap correction (deferred to C2C-review). Eight C2C-review class-C briefings and eight class-E evidence files remain in `docs/briefings/`. Historical cross-links in dated briefings and Phase B5 records preserved. |
