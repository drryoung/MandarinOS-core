...
>
> - **Current use:** Retained as historical evidence of capability mismatches observed during an earlier repository state.
> - **May guide current implementation:** No.
> - **Current authority:** Verified current capability, routing, content, and UI code together with the applicable R2 contracts.
> - **Principal caution:** A previously observed capability mismatch may no longer exist or may now have a different cause. Confirm every mismatch against the current application before modifying code.
