...
- `status-header-added` (20) covers the 12-file Phase B1 high-risk misleading-title set plus the 8-file Phase B2 remaining-superseded set (§15), both now approved; it does not change the 12-file misleading-title register in §11, and no file was removed from that register because a notice was added.
