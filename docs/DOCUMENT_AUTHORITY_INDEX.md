...
- `status-header-added` (64) covers the 12-file Phase B1, 8-file Phase B2, 11-file Phase B3A, 11-file Phase B3B, 12-file Phase B4A, and 10-file Phase B4B reports-directory sets (§15), all approved; it does not change the 12-file misleading-title register in §11, and no file was removed from that register because a notice was added. Exactly 23 class-E documents carry the flag (one Phase B1; 12 Phase B4A; 10 Phase B4B); 13 class-E documents remain for Phase B4C and B4D. All 22 class-F documents carry the flag through completed Phase B3.
