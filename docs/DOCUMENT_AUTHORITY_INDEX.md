...
Six class-C project notes relocated to `docs/archive/project/` in approved Phase C2D4 (see §17.8a). The class-F roadmap/notes documents and all class-E/G documents below are unaffected.
