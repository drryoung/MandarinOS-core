...
| `docs/archive/design-history/*` early design docs (C2D1 candidate) | 6 | Cards/trace/UX design era | `docs/ARCHITECTURE.md` | phase-specific |
...
| `docs/archive/design-history/` early design | 5 | C | Pre-R2 design era; relocated in Phase C2D1 candidate (`TRACE_CONTRACT_v1.md` is the sixth C2D1 class-C file, with Phase B5A notice — see §17.3a) |
...
**Phase C2D1 — design-history extraction (docs/design/, class C): 6 relocations — candidate completed 2026-07-15; pending review and approval.** Six class-C early-design files moved from `docs/design/` to `docs/archive/design-history/` via `git mv` (4 Low, 2 Medium). Current class-B design guidance (`docs/design/mandarinos_design_constitution.txt`, `docs/design/MANDARINOS_AI_GOVERNANCE_MODEL_v1.md`, `docs/design/LICENSE.md`) remains in place; class-D `CURSOR_STARTUP_PROTOCOL.md` and class-F proposals remain deferred to later batches. Active AI/bootstrap corrections: `AI_CONTEXT.md` §1.2/§11 removed obsolete always-consult/read-first treatment of `TRACE_CONTRACT_v1.md` and framed the archive path as optional historical context subordinate to `docs/ARCHITECTURE.md` and the R2 package; `.github/copilot-instructions.md` replaced "authoritative" framing of `MandarinOS Developer Handoff.txt` with `docs/DEVELOPER_ONBOARDING.md` plus an archive historical pointer. One active documentation link repaired in `integration_kit/README.md`. Bodies, notices (including the Phase B5A notice on `TRACE_CONTRACT_v1.md`), classes, flags, and authority fields unchanged. Phase C2A through C2C-review remain approved. C2D2 and later batches have not begun. Phase C remains incomplete. This entry is a **candidate**, not yet approved.
...
Mixed design directory remaining after Phase C2D1 candidate: three class-B current design-governance files; one class-D superseded onboarding protocol deferred to C2D2; two class-F proposals deferred to later proposal batches. Six class-C early-design files relocated to `docs/archive/design-history/` in the C2D1 candidate.
...
Archived early design documents (class C). Relocated from `docs/design/` in Phase C2D1 candidate; authority unchanged.

| Path | Class | Flags | Replacement/authority | Notes |
| ---- | ----- | ----- | --------------------- | ----- |
| `docs/archive/design-history/CARDS_BUILD_v1.md` | C | phase-specific | `docs/ARCHITECTURE.md` | Cards-build era. Relocated in Phase C2D1 candidate; authority unchanged. |
| `docs/archive/design-history/MandarinOS Developer Handoff.txt` | C | phase-specific | `docs/DEVELOPER_ONBOARDING.md` | Early handoff. Relocated in Phase C2D1 candidate; authority unchanged. |
| `docs/archive/design-history/MandarinOS_brief.md` | C | phase-specific | `docs/ARCHITECTURE.md` | Early project brief. Relocated in Phase C2D1 candidate; authority unchanged. |
| `docs/archive/design-history/TRACE_CONTRACT_v1.md` | C | phase-specific, implementation-not-verified, status-header-added | `docs/ARCHITECTURE.md` | Trace contract not in conversation runtime; Phase B5A notice approved. Relocated in Phase C2D1 candidate; authority unchanged. |
| `docs/archive/design-history/p3_architecture.md` | C | phase-specific | `docs/ARCHITECTURE.md` | Early architecture. Relocated in Phase C2D1 candidate; authority unchanged. |
| `docs/archive/design-history/ux_flow.txt` | C | phase-specific | `docs/ARCHITECTURE.md` | Early UX flow. Relocated in Phase C2D1 candidate; authority unchanged. |
