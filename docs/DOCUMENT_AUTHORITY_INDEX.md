...
Mixed design directory remaining after approved Phase C2D1: three class-B current design-governance files; one class-D superseded onboarding protocol deferred to C2D2; two class-F proposals deferred to later proposal batches. Six class-C early-design files relocated to `docs/archive/design-history/` in approved Phase C2D1.
