...
Six class-C project notes relocated to `docs/archive/project/` in Phase C2D4 candidate pass (see §17.8a; pending approval). The class-F roadmap/notes documents and all class-E/G documents below are unaffected.
...
Six class-C project notes relocated from `docs/project/` in Phase C2D4 candidate pass; authority unchanged; pending review and approval.

| Path | Class | Flags | Replacement/authority | Notes |
| ---- | ----- | ----- | --------------------- | ----- |
| `docs/archive/project/DIRECTIVE_PHASE_1_CARD_PANEL_STATE.md` | C | phase-specific | code + `docs/CHANGE_CHECKLIST.md` | Phase 1 directive. Relocated in Phase C2D4 candidate; authority unchanged |
| `docs/archive/project/ENGINES_P1_P2_AND_SRS_REFERENCE.md` | C | phase-specific | `docs/CONVERSATION_ARCHITECTURE.md` | Engine/SRS reference. Relocated in Phase C2D4 candidate; authority unchanged |
| `docs/archive/project/NEXT_QUESTION_SELECTOR_AND_LEVEL_TIE_IN.md` | C | phase-specific | `docs/CONVERSATION_ARCHITECTURE.md` | References LOCKED selector spec. Relocated in Phase C2D4 candidate; authority unchanged |
| `docs/archive/project/PROBE_QUESTIONS_RESPONSE_OPTIONS_NOTE.md` | C | phase-specific | `docs/CONVERSATION_ARCHITECTURE.md` | Probe-questions note. Relocated in Phase C2D4 candidate; authority unchanged |
| `docs/archive/project/TEST_DIAGNOSTIC_P1_MANUAL.md` | C | phase-specific | `docs/TEST_STRATEGY.md` | Manual diagnostic procedure. Relocated in Phase C2D4 candidate; authority unchanged |
| `docs/archive/project/USER_TURN_AND_PERSONA_QUESTIONS_NOTE.md` | C | phase-specific | `docs/CONVERSATION_ARCHITECTURE.md` | Persona-questions note. Relocated in Phase C2D4 candidate; authority unchanged |
