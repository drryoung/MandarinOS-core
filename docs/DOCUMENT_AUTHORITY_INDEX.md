...
One class-E dated-evidence document, `docs/session_intelligence_implementation_report.md`, relocated to `docs/evidence/session_intelligence_implementation_report.md` in candidate Phase C2E5 (see §17.2a; pending approval).

### 17.2a `docs/evidence/` (top level)

One class-E dated-evidence document relocated from `docs/` (top level) in candidate Phase C2E5; authority unchanged.

| Path | Class | Flags | Replacement/authority | Notes |
| ---- | ----- | ----- | --------------------- | ----- |
| `docs/evidence/session_intelligence_implementation_report.md` | E | dated-snapshot, status-header-added | dated evidence only | Implementation report. Phase B4D notice approved. Relocated in candidate Phase C2E5; authority unchanged |
...
One class-E dated-evidence document, `docs/state/MANDARINOS_SYSTEM_STATE_PHASE_12B.md`, relocated to `docs/evidence/state/MANDARINOS_SYSTEM_STATE_PHASE_12B.md` in candidate Phase C2E5 (see §17.11a; pending approval). No tracked file currently remains under `docs/state/`.

### 17.11a `docs/evidence/state/`

One class-E dated-evidence document relocated from `docs/state/` in candidate Phase C2E5; authority unchanged.

| Path | Class | Flags | Replacement/authority | Notes |
| ---- | ----- | ----- | --------------------- | ----- |
| `docs/evidence/state/MANDARINOS_SYSTEM_STATE_PHASE_12B.md` | E | dated-snapshot, misleading-filename, status-header-added | dated evidence only | Phase 12B state snapshot. Relocated in candidate Phase C2E5; authority unchanged |
