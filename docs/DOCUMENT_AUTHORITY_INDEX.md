...
Six class-C project notes relocated to `docs/archive/project/` in approved Phase C2D4 (see §17.8a). Twelve class-E project status/commit-evidence documents relocated to `docs/evidence/project/` in candidate Phase C2E3 (see §17.8b; pending review and approval). The class-F roadmap/notes documents and both class-G documents below are unaffected.
...
Twelve class-E project status/commit-evidence documents relocated from `docs/project/` in candidate Phase C2E3; authority unchanged; pending review and approval.

| Path | Class | Flags | Replacement/authority | Notes |
| ---- | ----- | ----- | --------------------- | ----- |
| `docs/evidence/project/ARCHITECTURE_ALIGNMENT_OPTIONS_AND_GOLD.md` | E | dated-snapshot, status-header-added | dated evidence only | Alignment options analysis. Phase B4A notice approved. Relocated in candidate Phase C2E3; authority unchanged |
| `docs/evidence/project/AUDIT_OPTION_GENERATION.md` | E | dated-snapshot, status-header-added | dated evidence only | Option-generation audit. Phase B4A notice approved. Relocated in candidate Phase C2E3; authority unchanged |
| `docs/evidence/project/COMMIT_RECORD.md` | E | dated-snapshot, status-header-added | dated evidence only | Commit record. Phase B4A notice approved. Relocated in candidate Phase C2E3; authority unchanged |
| `docs/evidence/project/COMMIT_SUMMARY.md` | E | dated-snapshot, duplicate-or-near-duplicate, status-header-added | dated evidence only | Commit summary. Phase B4A notice approved. Relocated in candidate Phase C2E3; authority unchanged |
| `docs/evidence/project/COMMIT_SUMMARY_v1.md` | E | dated-snapshot, duplicate-or-near-duplicate, status-header-added | dated evidence only | Commit summary v1. Phase B4A notice approved. Relocated in candidate Phase C2E3; authority unchanged |
| `docs/evidence/project/CORE_TREASURE_BRIDGE_STATUS.md` | E | dated-snapshot, status-header-added | dated evidence only | Bridge status report. Phase B4A notice approved. Relocated in candidate Phase C2E3; authority unchanged |
| `docs/evidence/project/DIAGNOSTIC_P1_VALIDATION_RESULTS.md` | E | dated-snapshot, status-header-added | dated evidence only | Diagnostic results. Phase B4A notice approved. Relocated in candidate Phase C2E3; authority unchanged |
| `docs/evidence/project/EXECUTIVE_SUMMARY_v1.md` | E | dated-snapshot, status-header-added | dated evidence only | Executive summary. Phase B4A notice approved. Relocated in candidate Phase C2E3; authority unchanged |
| `docs/evidence/project/OPTION_GENERATION_FIX_COMPLETE.md` | E | dated-snapshot, status-header-added | dated evidence only | Fix-complete report. Phase B4A notice approved. Relocated in candidate Phase C2E3; authority unchanged |
| `docs/evidence/project/PHASE9_STATUS_AND_RESPONSE_QUALITY.md` | E | dated-snapshot, status-header-added | dated evidence only | Phase 9 status. Phase B4A notice approved. Relocated in candidate Phase C2E3; authority unchanged |
| `docs/evidence/project/SPECS_TO_IMPLEMENTATION_GAP.md` | E | dated-snapshot, status-header-added | dated evidence only | Gap analysis. Phase B4A notice approved. Relocated in candidate Phase C2E3; authority unchanged |
| `docs/evidence/project/TEST_SUMMARY.md` | E | dated-snapshot, status-header-added | dated evidence only | Test summary. Phase B4A notice approved. Relocated in candidate Phase C2E3; authority unchanged |
